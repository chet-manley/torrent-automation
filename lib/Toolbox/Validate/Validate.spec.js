...
describe('Validate Object module', () => {
  ...
  describe('string method', () => {
    it('should return false on a Number', () => {
      expect(is.string(INT)).toBe(false)
  ...
  describe('toString method', () => {
    ...
    it('should return true on a Number', () => {
      ...
      expect(is.toString(Number(INT))).toBe(true)
      expect(is.toString(new Number)).toBe(true)
      expect(is.toString(new Number())).toBe(true)
      expect(is.toString(new Number(INT))).toBe(true)
    ...
    it('should return true on an Array', () => {
      expect(is.toString([])).toBe(true)
      expect(is.toString([''])).toBe(true)
      expect(is.toString([0,1])).toBe(true)
      expect(is.toString(Array())).toBe(true)
      expect(is.toString(Array([]))).toBe(true)
      expect(is.toString(Array(0,1))).toBe(true)
      expect(is.toString(new Array)).toBe(true)
      expect(is.toString(new Array())).toBe(true)
      expect(is.toString(new Array(0,1))).toBe(true)
    })
  ...
  describe('number method', () => {
    ...
    it('should return true on a Number literal', () => {
      ...
      expect(is.number(-INT)).toBe(true)
      expect(is.number(EXP)).toBe(true)
      expect(is.number(Number())).toBe(true)
      expect(is.number(Number(-INT))).toBe(true)
    })

    it('should return true on a Number object', () => {
      expect(is.number(new Number)).toBe(true)
      expect(is.number(new Number(INT))).toBe(true)
    })
  })
  ...
  describe('realNumber method', () => {
    ...
    it('should return true on a Number literal', () => {
      ...
      expect(is.realNumber(-0)).toBe(true)
      expect(is.realNumber(EXP)).toBe(true)
      expect(is.realNumber(Number(-FLOAT))).toBe(true)
    })
    ...
    it('should return true on a String containing a number', () => {
      ...
      expect(is.realNumber(new String(EXP))).toBe(true)
      expect(is.realNumber(new String(`${-FLOAT}`))).toBe(true)
    })
  })
  ...
  describe('integer method', () => {
    ...
    it('should return true on an Integer Number literal', () => {
      ...
      expect(is.integer(-0)).toBe(true)
      expect(is.integer(EXP)).toBe(true)
      expect(is.integer(Number(-0))).toBe(true)
    })
    ...
    it('should return true on an Integer as a String', () => {
      ...
      expect(is.integer(new String(EXP))).toBe(true)
      expect(is.integer(new String(`${-INT}`))).toBe(true)
    })

    it('should return false on a Floating Point as Number or String', () => {
      expect(is.integer(FLOAT)).toBe(false)
      expect(is.integer(`${FLOAT}`)).toBe(false)
      expect(is.integer(-FLOAT)).toBe(false)
      expect(is.integer(`${-FLOAT}`)).toBe(false)
    })
